...
If you want to test GroupDocs.Viewer without the limitations of the trial version,   request a 30-day Temporary License. For details, see the <a href="https://purchase.groupdocs.com/temporary-license" rel="nofollow">Get a Temporary License</a> page.
...
*   As a Metered License that allows you to pay for your usage. For details, see the <a href="https://purchase.groupdocs.com/faqs/licensing/metered/" rel="nofollow">Metered Licensing FAQ</a>.
...
Use the <a href="https://reference.groupdocs.com/viewer/net/groupdocs.viewer/license/setlicense/" rel="nofollow">SetLicense</a> method to license a component.

Calling `SetLicense` multiple times is not harmful, it simply wastes processor time.

Calling <a href="https://reference.groupdocs.com/viewer/net/groupdocs.viewer/metered/setmeteredkey/" rel="nofollow">SetMeteredKey</a> multiple times is not harmful either but wastes processor time and can accumulate consumption improperly.
...
You can set the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/metered" rel="nofollow">Metered</a> license as an alternative to license file. It is useful for the customers who want to be billed based on the usage of the API features. For more details, please refer to <a href="https://purchase.groupdocs.com/faqs/licensing/metered" rel="nofollow">Metered Licensing FAQ</a>.
