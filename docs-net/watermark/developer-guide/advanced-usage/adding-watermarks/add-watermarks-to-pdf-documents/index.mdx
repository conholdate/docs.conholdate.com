...
sidebar_label: "To PDF documents"
sidebar_key: "net-watermark-adding-watermarks-add-watermarks-to-pdf-documents-index"
sidebar_position: 6
...
source_path: "net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-pdf-documents/_index.md"
source_commit: "a0e4e96832f8703735e1f226dc5a99e7b62f88cb"
source_sha256: "673a94dfb5071395d40c4b60135364e704f9fed9a32339ec36e3f60631c165df"
---
...
4. Add watermark to the page of the document using property <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.options.pdf/pdfartifactwatermarkoptions/properties/pageindex" target="_blank" rel="nofollow noopener noreferrer">PageIndex</a> of <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.options.pdf/pdfartifactwatermarkoptions" target="_blank" rel="nofollow noopener noreferrer">PdfArtifactWatermarkOptions</a>
5. Save the document
...
If for some reasons you want to use absolute sizing and positioning, you may also need to determine page size. GroupDocs.Watermark also provides the feature to get the dimensions of the page in a PDF document. Below example shows how to get <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.contents.pdf/pdfpage/properties/width" target="_blank" rel="nofollow noopener noreferrer">width</a> and <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.contents.pdf/pdfpage/properties/height" target="_blank" rel="nofollow noopener noreferrer">height</a> of a particular page.
...
If a PDF document contains a crop box definition, Adobe Acrobat uses it for screen display and printing. That's why GroupDocs.Watermark uses crop box by default to calculate relative watermark size and position. When you set <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark/watermark/properties/considerparentmargins" target="_blank" rel="nofollow noopener noreferrer">Watermark.ConsiderParentMargins</a> property to true, trim box rectangle is used instead. But what if you want to get watermark aligned to bleed box or art box? In this case, you need to set the appropriate value to <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.contents.pdf/pdfcontent/properties/pagemargintype" target="_blank" rel="nofollow noopener noreferrer">PdfContent.PageMarginType</a> property as shown in the below example.
...
GroupDocs.Watermark also provides the feature to add watermark to supported files in all <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.contents.pdf/pdfcontent/properties/attachments" target="_blank" rel="nofollow noopener noreferrer">attachments</a> in a PDF document. Below example shows how to add watermark to all supported attachments.
...
* [Attachments in PDF document](/net/watermark/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-pdf-documents/attachments-in-pdf-document/ "Attachments in PDF document")
* [Existing objects in PDF document](/net/watermark/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-pdf-documents/existing-objects-in-pdf-document/ "Existing objects in PDF document")
* [Rasterize document or page](/net/watermark/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-pdf-documents/rasterize-document-or-page/ "Rasterize document or page")
* [Watermarks in PDF document](/net/watermark/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-pdf-documents/watermarks-in-pdf-document/ "Watermarks in PDF document")
