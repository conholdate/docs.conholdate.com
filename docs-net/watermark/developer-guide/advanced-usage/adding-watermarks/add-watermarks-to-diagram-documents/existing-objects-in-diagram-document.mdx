...
sidebar_label: "Existing objects in diagrams"
sidebar_key: "net-watermark-adding-watermarks-add-watermarks-to-diagram-documents-existing-objects-in-diagram-document"
sidebar_position: 1
...
source_path: "net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-diagram-documents/existing-objects-in-diagram-document.md"
source_commit: "a0e4e96832f8703735e1f226dc5a99e7b62f88cb"
source_sha256: "394d432e13df1b9df88f345f104d3bb7c16b9cc6ed86bbd8beadca29297e2914"
---
...
3. <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.contents.contentpart/search/methods/1" target="_blank" rel="nofollow noopener noreferrer">Find</a> possible watermarks
...
*<a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.contents.contentpart/search/methods/1" target="_blank" rel="nofollow noopener noreferrer">Search</a>* method searches watermarks of all mentioned types, but in some cases, it's necessary to analyze only one type of Visio objects. Following code sample shows how to get information about all the shapes in a Visio document.
