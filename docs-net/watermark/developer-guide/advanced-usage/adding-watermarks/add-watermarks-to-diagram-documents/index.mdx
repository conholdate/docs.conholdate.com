...
sidebar_label: "To diagrams"
sidebar_key: "net-watermark-adding-watermarks-add-watermarks-to-diagram-documents-index"
sidebar_position: 3
...
source_path: "net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-diagram-documents/_index.md"
source_commit: "a0e4e96832f8703735e1f226dc5a99e7b62f88cb"
source_sha256: "dfaab10b138954f6152c5a7cf1690da65aa6118ac88ed4b77511f623b1b092fe"
---
...
4. Add watermark by specifying page type using <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.options.diagram/diagramshapewatermarkoptions/properties/placementtype" target="_blank" rel="nofollow noopener noreferrer">PlacementType</a> of <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.options.diagram/diagramshapewatermarkoptions" target="_blank" rel="nofollow noopener noreferrer">DiagramShapeWatermarkOptions</a>
5. Save the document
...
GroupDocs.Watermark allows you to add watermark to a particular page of the document using <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.options.diagram/diagrampagewatermarkoptions/properties/pageindex" target="_blank" rel="nofollow noopener noreferrer">PageIndex</a> of <a href="https://reference.groupdocs.com/net/watermark/groupdocs.watermark.options.diagram/diagrampagewatermarkoptions" target="_blank" rel="nofollow noopener noreferrer">DiagramPageWatermarkOptions</a> as shown in below example.
...
* [Existing objects in diagram document](/net/watermark/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-diagram-documents/existing-objects-in-diagram-document/ "Existing objects in diagram document")
