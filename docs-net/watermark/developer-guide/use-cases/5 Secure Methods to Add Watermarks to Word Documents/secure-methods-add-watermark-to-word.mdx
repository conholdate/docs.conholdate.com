...
sidebar_label: "5 Secure Methods to Add Watermarks to Word Documents"
sidebar_key: "net-watermark-5-secure-methods-to-add-watermarks-to-word-documents-secure-methods-add-watermark-to-word"
sidebar_position: 1
...
source_path: "net/developer-guide/use-cases/5 Secure Methods to Add Watermarks to Word Documents/secure-methods-add-watermark-to-word.md"
source_commit: "a0e4e96832f8703735e1f226dc5a99e7b62f88cb"
source_sha256: "2407028d06d645ebf3428c7ff05384c0df854914b2129ee19528a716993f99a4"
---
...
:::info
For the **complete working code** and detailed explanations, please refer to the <a href="https://github.com/groupdocs-watermark/protect-word-documents-using-groupdocs-watermark-dotnet/" target="_blank" rel="nofollow noopener noreferrer">full repository here</a>.
:::
...
![how-to](/net/watermark/images/use-cases/secure-methods-add-watermark-to-word/2_remove_text_watermark_in_header.gif)
...
![how-to](/net/watermark/images/use-cases/secure-methods-add-watermark-to-word/3_tiled_watermark.gif)
...
![how-to](/net/watermark/images/use-cases/secure-methods-add-watermark-to-word/3.1_tiled_image_watermark.gif)
...
![how-to](/net/watermark/images/use-cases/secure-methods-add-watermark-to-word/4_allow_only_form_fields.gif)
...
**Watch the locked header protection:**
![how-to](/net/watermark/images/use-cases/secure-methods-add-watermark-to-word/5_watermark_locked_in_header.gif)
