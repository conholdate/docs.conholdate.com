...
sidebar_label: "Batch Watermarking with Duplicate-Safe Processing"
sidebar_key: "net-watermark-batch-document-watermarking-pipeline-batch-watermark-pipeline"
sidebar_position: 10
...
source_path: "net/developer-guide/use-cases/Batch Document Watermarking Pipeline/batch-watermark-pipeline.md"
source_commit: "a0e4e96832f8703735e1f226dc5a99e7b62f88cb"
source_sha256: "7d4a29f120d82118d5c276582b0b92433e82994d17f9526879bbe8d9cdd9919d"
---
...
![Text watermark applied to a document](/net/watermark/images/use-cases/batch-watermark-pipeline/1-example-text.png)
...
![Tiled logo watermark applied to a document](/net/watermark/images/use-cases/batch-watermark-pipeline/3-example-image.png)
...
![Old logo replaced with new logo](/net/watermark/images/use-cases/batch-watermark-pipeline/4-example-logo-replace.png)
...
- <a href="https://docs.groupdocs.com/watermark/net/" target="_blank" rel="nofollow noopener noreferrer">GroupDocs.Watermark Documentation - .NET</a>
- <a href="https://reference.groupdocs.com/watermark/net/" target="_blank" rel="nofollow noopener noreferrer">API Reference - Watermarker Class</a>
- <a href="https://github.com/groupdocs-watermark/GroupDocs.Watermark-for-.NET/tree/main/net/sample-project" target="_blank" rel="nofollow noopener noreferrer">GitHub Repository - Sample Project</a>
- <a href="https://purchase.groupdocs.com/temp-license/100354" target="_blank" rel="nofollow noopener noreferrer">Temporary License Request</a>
- <a href="https://forum.conholdate.com/" target="_blank">GroupDocs Forum - Watermark Tag</a>
