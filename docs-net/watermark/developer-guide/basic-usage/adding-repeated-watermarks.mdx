...
sidebar_label: "Repeated watermarks"
sidebar_position: 3
...
source_path: "net/developer-guide/basic-usage/adding-repeated-watermarks.md"
source_commit: "a0e4e96832f8703735e1f226dc5a99e7b62f88cb"
source_sha256: "cfce1ec518bcd88e60869ca5fba52c54ff7c71b61b8b9dd52a985cd859cd5626"
---
...
The provided code snippet demonstrates how to add a tiled watermark to a document. To configure tiling settings, we can utilize the dedicated class <a href="https://reference.groupdocs.com/watermark/net/groupdocs.watermark.watermarks/tileoptions" target="_blank" rel="nofollow noopener noreferrer">TileOptions</a>. In this example, we set the LineSpacing property, determining the spacing between parallel tiles, to 12 percent of the page size. Additionally, we define the WatermarkSpacing property, which sets the spacing between watermarks in the line, to be 10 percent of the page size. Next image helps to understand the purpose of LineSpacing and WatermarkSpacing settings:
![adding-repeated-watermarks](/net/watermark/images/tilling-options.png)
...
![text repeated watermarks](/net/watermark/images/tilling-text-30.png)

The common rotation of watermarks on the above image is done relative to the left edge of the document. It's also possible to do the common rotation relative to the bottom left edge of the document. For this need to set property <a href="https://reference.groupdocs.com/watermark/net/groupdocs.watermark.watermarks/tileoptions/rotatearoundorigin/" target="_blank" rel="nofollow noopener noreferrer">RotateAroundOrigin</a> of the class TileOptions in the true.
```csharp
watermark.TileOptions.RotateAroundOrigin = true;
```
In such case the result of repeated watermark looks like this:
![repeated watermarks rotaion around the center](/net/watermark/images/tilling-text-center.png)

Class TileOptions includes a <a href="https://reference.groupdocs.com/watermark/net/groupdocs.watermark.watermarks/tiletype" target="_blank" rel="nofollow noopener noreferrer">TileType</a> property, providing the ability to configure the tile template. The default value is Straight mode, but we can change it. For instance, in the previous example, if we add the setting 
```csharp
...
![adding-repeated-watermarks](/net/watermark/images/tilling-text-30-offset.png)
...
![adding-repeated-watermarks](/net/watermark/images/basket-weave.png)
...
![adding-repeated-watermarks](/net/watermark/images/tilling-image-30.png)