...
sidebar_key: "net-conversion-tab"
sidebar_position: 5
...
source_sha256: "6bb93ecf8bbb3c04532641b1e619a5e9451c4a2499387a2b9b9670e783d87049"
---
...
Version 26.6 introduces the [ConversionEvents](/net/conversion/developer-guide/advanced-usage/conversion-events/) aggregator - a single typed object that replaces three previously separate registration paths: the per-handler properties on `ConverterSettings`, the `IConverterListener` assigned to `ConverterSettings.Listener`, and the fluent chain methods placed after `WithOptions(...)` or `Compress(...)`. The old surfaces continue to work but are obsolete and planned for removal in **v26.9**.
...
**Before** - implement <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.reporting/iconverterlistener/" target="_blank" rel="nofollow noopener noreferrer">IConverterListener</a> and assign the instance to `ConverterSettings.Listener`:
...
See [Conversion events](/net/conversion/developer-guide/advanced-usage/conversion-events/) for the full reference.
