...
sidebar_label: "Convert Image using OCR"
sidebar_key: "net-conversion-converting-conversion-options-by-document-family-convert-image-using-ocr"
sidebar_position: 11
...
source_path: "net/developer-guide/advanced-usage/converting/conversion-options-by-document-family/convert-image-using-ocr.md"
source_commit: "ae53e8b8df19b14cb813176a9a94df272f6779aa"
source_sha256: "8fb38b16b37de275aa82c366bf9103580003d62128a3c77363acc77eec83446f"
---
...
GroupDocs.Conversion for .NET provide an extension point which allows convert images using OCR processing. To use this you have to implement **<a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.integration.ocr/iocrconnector" target="_blank" rel="nofollow noopener noreferrer">IOcrConnector</a>** interface and provide instance of it in **<a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/imageloadoptions" target="_blank" rel="nofollow noopener noreferrer">ImageLoadOptions</a>**.
...
First create a class that implements <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.integration.ocr/iocrconnector" target="_blank" rel="nofollow noopener noreferrer">IOcrConnector</a>**
```csharp
...
Then provide **OcrConnector** instance in **<a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/rasterimageloadoptions" target="_blank" rel="nofollow noopener noreferrer">RasterImageLoadOptions</a>**:
