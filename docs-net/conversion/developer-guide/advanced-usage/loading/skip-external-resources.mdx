...
sidebar_label: "Skip loading of external resources"
sidebar_key: "net-conversion-loading-skip-external-resources"
sidebar_position: 4
...
source_path: "net/developer-guide/advanced-usage/loading/skip-external-resources.md"
source_commit: "ae53e8b8df19b14cb813176a9a94df272f6779aa"
source_sha256: "a38d509da5bd0c8eb52dec62d81341fc6a8028373a32d9bb88e034170db1399d"
---
...
To mitigate these risks, <a href="https://products.groupdocs.com/conversion/net" target="_blank" rel="nofollow noopener noreferrer">**GroupDocs.Conversion**</a> implements a **secure by default** approach - the `SkipExternalResources` property is set to `true` by default in all supporting load options classes.
...
| --------------- | ------------------- |
| Web/HTML | <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/webloadoptions" target="_blank" rel="nofollow noopener noreferrer">WebLoadOptions</a> |
| Word Processing | <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/wordprocessingloadoptions" target="_blank" rel="nofollow noopener noreferrer">WordProcessingLoadOptions</a> |
| Presentations | <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/presentationloadoptions" target="_blank" rel="nofollow noopener noreferrer">PresentationLoadOptions</a> |
| Spreadsheets | <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/spreadsheetloadoptions" target="_blank" rel="nofollow noopener noreferrer">SpreadsheetLoadOptions</a> |
| Email | <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/emailloadoptions" target="_blank" rel="nofollow noopener noreferrer">EmailLoadOptions</a> |
| SVG | <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/svgloadoptions" target="_blank" rel="nofollow noopener noreferrer">SvgLoadOptions</a> |

All these classes implement the <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.load/iresourceloadingoptions" target="_blank" rel="nofollow noopener noreferrer">IResourceLoadingOptions</a> interface, which defines the `SkipExternalResources` and `WhitelistedResources` properties.
