...
sidebar_label: "Conversion events"
sidebar_key: "net-conversion-conversion-events"
sidebar_position: 4
...
source_path: "net/developer-guide/advanced-usage/conversion-events.md"
source_commit: "ae53e8b8df19b14cb813176a9a94df272f6779aa"
source_sha256: "199adb0953c6cc05623e00bdc4cd68d9b94f32fda54dc13bd66144592ee0a3eb"
---
...
Starting with **GroupDocs.Conversion for .NET v26.6**, conversion event handlers are aggregated into a single typed object - <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion/conversionevents/" target="_blank" rel="nofollow noopener noreferrer">ConversionEvents</a>. This replaces three previously separate registration paths:

* The <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.reporting/iconverterlistener/" target="_blank" rel="nofollow noopener noreferrer">IConverterListener</a> interface assigned to <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion/convertersettings/listener/" target="_blank" rel="nofollow noopener noreferrer">ConverterSettings.Listener</a> - for pipeline lifecycle callbacks.
...
The aggregator is registered with the <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion/converter/" target="_blank" rel="nofollow noopener noreferrer">Converter</a> constructor via a new `events:` factory parameter, or with the fluent API via the entry-stage `FluentConverter.WithEvents(...)` method.
...
:::warning[Name reuse - read before upgrading]
...
| `OnCompressionCompleted` | `Action<Stream>` | After contents have been converted and packaged into a compressed archive (see [Extract and Convert Archive Contents](/net/conversion/developer-guide/advanced-usage/converting/conversion-options-by-document-family/convert-contents-of-rar-or-zip-document-to-different-formats-and-compress/)) |

See [Context Objects - Complete Guide](/net/conversion/developer-guide/basic-usage/context-objects-complete-guide/) for the properties exposed by `ConvertedContext`, `ConvertContext`, and `ConvertedPageContext`.
...
The fluent API exposes a single entry-stage method - <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion/fluentconverter/withevents/" target="_blank" rel="nofollow noopener noreferrer">WithEvents</a> - that accepts a builder action and replaces the per-method chain previously placed after `ConvertTo(...).WithOptions(...)`:
...
When converting and re-compressing archive contents (see [Extract and Convert Archive Contents](/net/conversion/developer-guide/advanced-usage/converting/conversion-options-by-document-family/convert-contents-of-rar-or-zip-document-to-different-formats-and-compress/)), `OnCompressionCompleted` is invoked once the new archive stream is ready:
...
`OnFontSubstituted` notifies you whenever a font referenced by the source document is unavailable and gets substituted during conversion - either because the font is missing from the machine, or because you configured a <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.contracts/fontsubstitute/" target="_blank" rel="nofollow noopener noreferrer">FontSubstitute</a> rule (see [Specify font substitution](/net/conversion/developer-guide/advanced-usage/loading/load-options-for-different-document-types/load-wordprocessing-document-with-options/#specify-font-substitution)). The handler receives a `FontSubstitutionContext` describing the substitution.
...
See [Context Objects - Complete Guide](/net/conversion/developer-guide/basic-usage/context-objects-complete-guide/#fontsubstitutioncontext) for more detail.
...
See the [migration notes](/net/conversion/developer-guide/migration-notes/) for a step-by-step upgrade guide.
