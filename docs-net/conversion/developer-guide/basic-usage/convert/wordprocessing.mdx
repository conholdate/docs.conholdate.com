...
sidebar_label: "Word processing documents"
sidebar_key: "net-conversion-convert-wordprocessing"
sidebar_position: 20
...
source_path: "net/developer-guide/basic-usage/convert/wordprocessing.md"
source_commit: "ae53e8b8df19b14cb813176a9a94df272f6779aa"
source_sha256: "e9fe8a8ac8f0f6f774be789b7d33448d527490ef0bf317940ae72f67bd570e3f"
---
...
<!-- Missing include: /net/conversion/_includes/supported-conversions/word-processing/ -->
...
When converting a DOC or DOCX file to MHTML format the only difference from the previous code example is that it is needed to set the  <a href="https://reference.groupdocs.com/conversion/net/groupdocs.conversion.options.convert/webconvertoptions" target="_blank" rel="nofollow noopener noreferrer">WebConvertOptions</a> `Format` property to  **WebFileType.Mhtml**. The code snippet for DOCX to MHTML conversion will look as follows:
