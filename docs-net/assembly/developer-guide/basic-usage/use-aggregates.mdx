...
sidebar_label: "Use Simple Aggregates (Sum, Count, Average)"
sidebar_key: "net-assembly-use-aggregates"
sidebar_position: 24
...
source_path: "net/developer-guide/basic-usage/use-aggregates.md"
source_commit: "110b986ad18aed0d87ecba6188f70cab0aadd69c"
source_sha256: "c198476e968dd4bfcc154ac115978db9dbd01eb8ea56e425e6f6f0e8ab248366"
---
...
To learn more about grouping, filtering with aggregates, custom aggregate functions, and performance optimization, please refer to the [advanced usage section](/net/assembly/developer-guide/advanced-usage/).
