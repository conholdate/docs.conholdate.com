...
sidebar_label: "Generate Document from Database"
sidebar_key: "net-assembly-generate-from-database"
sidebar_position: 9
...
source_path: "net/developer-guide/basic-usage/generate-from-database.md"
source_commit: "110b986ad18aed0d87ecba6188f70cab0aadd69c"
source_sha256: "08e5a9db48ba0d6f34034281bf40c995428e51d4e038e9e42a08630add20c96f"
---
...
To learn more about working with complex database queries, stored procedures, parameterized queries, and performance optimization for large datasets, please refer to the [advanced usage section](/net/assembly/developer-guide/advanced-usage/).
