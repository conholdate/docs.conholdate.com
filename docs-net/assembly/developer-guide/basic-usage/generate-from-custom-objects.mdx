...
sidebar_label: "Generate Document from Custom .NET Objects"
sidebar_key: "net-assembly-generate-from-custom-objects"
sidebar_position: 6
...
source_path: "net/developer-guide/basic-usage/generate-from-custom-objects.md"
source_commit: "110b986ad18aed0d87ecba6188f70cab0aadd69c"
source_sha256: "9c2d051b8ef7e67e6e00bd388cb54bdf7e44336a64f3b411c7fc4f9d3812cfc0"
---
...
- <a href="https://reference.groupdocs.com/assembly/net/groupdocs.assembly/datasourceinfo/" target="_blank" rel="nofollow noopener noreferrer">DataSourceInfo</a> - wraps data source objects
...
To learn more about working with complex object hierarchies, collections, LINQ queries on objects, and performance optimization, please refer to the [advanced usage section](/net/assembly/developer-guide/advanced-usage/).
