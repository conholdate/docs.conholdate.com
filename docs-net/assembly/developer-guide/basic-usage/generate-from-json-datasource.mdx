...
sidebar_label: "Generate Document from JSON Data Source"
sidebar_key: "net-assembly-generate-from-json-datasource"
sidebar_position: 8
...
source_path: "net/developer-guide/basic-usage/generate-from-json-datasource.md"
source_commit: "110b986ad18aed0d87ecba6188f70cab0aadd69c"
source_sha256: "7c5632035eb36e3cba69d8f400eea385d746d7dff98f5246e3b6b86961f4e984"
---
...
- <a href="https://reference.groupdocs.com/assembly/net/groupdocs.assembly/jsondatasource/" target="_blank" rel="nofollow noopener noreferrer">JsonDataSource</a> - loads and parses JSON data
- <a href="https://reference.groupdocs.com/assembly/net/groupdocs.assembly/documentassembler/" target="_blank" rel="nofollow noopener noreferrer">DocumentAssembler</a> - assembles documents from templates
- <a href="https://reference.groupdocs.com/assembly/net/groupdocs.assembly/datasourceinfo/" target="_blank" rel="nofollow noopener noreferrer">DataSourceInfo</a> - wraps the data source
...
To learn more about working with complex JSON structures, date-time parsing, and advanced JsonDataSource options, please refer to the [advanced usage section](/net/assembly/developer-guide/advanced-usage/).
