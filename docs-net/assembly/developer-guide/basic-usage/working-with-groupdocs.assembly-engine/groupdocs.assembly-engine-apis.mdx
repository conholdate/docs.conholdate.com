...
sidebar_label: "GroupDocs.Assembly Engine APIs"
sidebar_key: "net-assembly-working-with-groupdocs-assembly-engine-groupdocs-assembly-engine-apis"
sidebar_position: 3
description: ""
product: "assembly"
platform: "net"
...
source_path: "net/developer-guide/basic-usage/working-with-groupdocs.assembly-engine/groupdocs.assembly-engine-apis.md"
source_commit: "110b986ad18aed0d87ecba6188f70cab0aadd69c"
source_sha256: "aa8f9bf8273ae0f89082dcb159a5befe66c84c5923dec7b17593b59cd58f3064"
---
...
:::info
In this article, we will discuss the behavior of GroupDocs.Assembly APIs.
:::
...
| dataSource | An object providing a data to populate the specified template. The object must be of one of the following types:`JsonDataSource`; `XmlDataSource`; `CsvDataSource`; `DataSet`; `DataTable`; `DataRow`; `DataView`; `DataRowView`; `IDataReader`; `IDataRecord`; An object of a custom <a href="https://docs.groupdocs.com/assembly/net/template-syntax-part-1-of-2/#using-types" target="_blank" rel="nofollow noopener noreferrer">visible type</a> |
| dataSourceName | The identifier of the specified data source object within the specified template. You can omit this identifier, if the template uses the <a href="https://docs.groupdocs.com/assembly/net/template-syntax-part-1-of-2/#using-contextual-object-member-access" target="_blank" rel="nofollow noopener noreferrer">contextual object member access</a> when dealing with the data source. |
...
GroupDocs.Assembly Engine must be aware of custom external types that you reference in your template before the engine processes the template. You can set up external types known by the engine through the DocumentAssembler.KnownTypes property. The property represents an unordered set (that is, a collection of unique items) of <a href="http://msdn.microsoft.com/en-us/library/system.type(v=vs.110" target="_blank" rel="nofollow noopener noreferrer">Type</a>.aspx) objects. Every type in the set must meet requirements declared at <a href="https://docs.groupdocs.com/assembly/net/template-syntax-part-1-of-2/#using-types" target="_blank" rel="nofollow noopener noreferrer">Working with Types</a>.
...
The engine does not cooperate with <a href="http://msdn.microsoft.com/en-us/library/vstudio/bb882640(v=vs.110" target="_blank" rel="nofollow noopener noreferrer">LINQ providers</a>.aspx). To be aware of consequences of this feature, consider the following example.
...
You can use a tool like <a href="http://research.microsoft.com/en-us/people/mbarnett/ilmerge.aspx" target="_blank" rel="nofollow noopener noreferrer">ILMerge</a> to merge GroupDocs.Assembly library with another assembly. But in order to use the Engine, please add the following attribute to the target assembly.
