...
sidebar_label: "Barcodes Syntax and Properties"
sidebar_key: "net-assembly-working-with-barcode-image-generation-barcodes-syntax-and-properties"
sidebar_position: 1
description: ""
product: "assembly"
platform: "net"
...
source_path: "net/developer-guide/advanced-usage/working-with-barcode-image-generation/barcodes-syntax-and-properties.md"
source_commit: "110b986ad18aed0d87ecba6188f70cab0aadd69c"
source_sha256: "0e66a385ae7596d682f6fd10c694b3eaf144e199a0872e1a02de041b20cd24aa"
---
...
:::warning
When the scale attribute is provided for a barcode tag, actual x- and y-dimensions are calculated by the engine as the corresponding percent of base x- and y-dimensions.
:::
...
:::warning
The auto-correction is not possible for barcodes of some types like Databar.
:::
...
:::warning
By default, horizontal and vertical resolution of dynamically inserted barcode images is 96 DPI
:::
