...
:::info
Runnig this code requires installing <a href="https://nuget.org/packages/AWSSDK.S3" target="_blank" rel="nofollow noopener noreferrer">AWSSDK.S3</a> NuGet package.
:::
