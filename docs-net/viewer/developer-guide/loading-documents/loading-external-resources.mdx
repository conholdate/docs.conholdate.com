...
- <a href="https://docs.fileformat.com/word-processing/" target="_blank" rel="nofollow noopener noreferrer">Word Processing File Formats</a>
- <a href="https://docs.fileformat.com/web/" target="_blank" rel="nofollow noopener noreferrer">Web File Formats</a>
- <a href="https://docs.fileformat.com/spreadsheet/" target="_blank" rel="nofollow noopener noreferrer">SpreadSheet File Formats</a>

Use the <a href="https://reference.groupdocs.com/viewer/net/groupdocs.viewer.options/loadoptions" target="_blank" rel="nofollow noopener noreferrer">LoadOptions</a> object to manage loading of external resources.
