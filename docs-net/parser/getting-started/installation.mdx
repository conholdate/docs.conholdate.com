...
sidebar_key: "net-parser-installation"
sidebar_position: 4
...
source_sha256: "9915ce078930fc1a2f87dd8e9d6a59909e4bd5f80d484083cdbba7b3f218c95b"
---
...
![](/net/parser/images/installation.png)
...
![](/net/parser/images/installation_1.png)

![](/net/parser/images/installation_2.png)

Starting with 24.2 version, GroupDocs.Parser is divided into two packages - for .NET Framework and .NET Standard. GroupDocs.Parser for .NET Framework package is recommended for using with .NET Framework projects. GroupDocs.Parser package is designed to work with .NET projects. You need to <a href="https://stackoverflow.com/questions/43365736/assembly-binding-redirect-how-and-why" target="_blank" rel="nofollow noopener noreferrer">configure binding redirection</a> to make it work with .NET Framework. For regular .NET Framework project it's required to <a href="https://learn.microsoft.com/en-us/dotnet/framework/configure-apps/how-to-enable-and-disable-automatic-binding-redirection" target="_blank" rel="nofollow noopener noreferrer">enable automatic binding redirection</a>. For unit tests projects you also need to specify `GenerateBindingRedirectsOutputType` in the project file:
