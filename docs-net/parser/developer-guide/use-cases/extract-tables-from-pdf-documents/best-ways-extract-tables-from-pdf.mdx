...
sidebar_label: "Extract Tables from PDF Documents"
sidebar_key: "net-parser-extract-tables-from-pdf-documents-best-ways-extract-tables-from-pdf"
sidebar_position: 1
...
source_path: "net/developer-guide/use-cases/extract-tables-from-pdf-documents/best-ways-extract-tables-from-pdf.md"
source_commit: "e3b3a2df0663abc09348cedab04e0e649de093a4"
source_sha256: "1425ed13ba9a6fd265145671810c57e52be28ec85237f1a21f6ab5e4155fab54"
---
...
:::info
For the **complete working code** and detailed explanations, please refer to the <a href="https://github.com/groupdocs-parser/Pdf-tables-extraction-using-groupdocs-parser" target="_blank" rel="nofollow noopener noreferrer">full repository here</a>.
:::
...
**Source Document:**
![PDF Document Page](pathname:///net/parser/images/use-cases/best-ways-extract-tables-from-pdf-document-page-01.png)

**Extracted Tables Output:**
![Console Output](pathname:///net/parser/images/use-cases/best-ways-extract-tables-from-pdf-console-output-01.png)
