...
sidebar_label: "Extract Annotations from PDF Documents"
sidebar_key: "net-parser-extract-annotations-from-pdf-documents-extract-annotations-from-pdf-documents"
sidebar_position: 20
...
source_path: "net/developer-guide/use-cases/extract-annotations-from-pdf-documents/extract-annotations-from-pdf-documents.md"
source_commit: "e3b3a2df0663abc09348cedab04e0e649de093a4"
source_sha256: "e8455477e342d76713e8d9b0d2836bfe3d423745b3aa14444e196ddbbfe64c30"
---
...
<a href="https://github.com/groupdocs-parser/extract-annotations-from-pdf-using-groupdocs-parser-dotnet/" target="_blank" rel="nofollow noopener noreferrer">extract-annotations-from-pdf-documents-using-groupdocs-parser-dotnet</a>
:::
...
GroupDocs.Parser added native annotation extraction for PDF documents in version 26.7 via the <a href="https://reference.groupdocs.com/parser/net/groupdocs.parser/parser/getannotations/" target="_blank" rel="nofollow noopener noreferrer">GetAnnotations</a> method - see the <a href="https://releases.groupdocs.com/parser/net/release-notes/2026/groupdocs-parser-for-net-26-7-release-notes/" target="_blank" rel="nofollow noopener noreferrer">26.7 release notes</a> for the full API change list.
