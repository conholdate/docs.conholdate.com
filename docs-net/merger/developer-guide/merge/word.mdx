...
sidebar_label: "Merge Word documents"
sidebar_key: "net-merger-merge-word"
sidebar_position: 40
...
source_path: "net/developer-guide/merge/word.md"
source_commit: "a94e0e4d7474596613a34f623effd20176c5227b"
source_sha256: "84428101dd036fa2817f2f2350438140f843d1bf28e24ebc19698b19552b628f"
---
...
Please read the following article: [How to correctly merge DOCX streams](/net/merger/getting-started/use-cases/how-to-correctly-merge-documents-using-csharp/)

### Code Examples

Please find more <a href="https://docs.groupdocs.com/merger/net/showcases/" target="_blank" rel="nofollow noopener noreferrer">use-cases and complete C# sources</a> of our backend and frontend examples and try them for free!

### Merge Word files Live Demo

GroupDocs.Merger for .NET provides an online <a href="https://products.groupdocs.app/merger/word" target="_blank" rel="nofollow noopener noreferrer">**Word Merger App**</a>, which allows you to try it for free and check its quality and accuracy.
