...
sidebar_label: "PDF Binder Demo: Merging Multiple Formats into a Single PDF"
sidebar_key: "net-merger-use-cases-how-to-create-pdf-binder-using-csharp"
...
source_path: "net/getting-started/use-cases/how-to-create-pdf-binder-using-csharp.md"
source_commit: "a94e0e4d7474596613a34f623effd20176c5227b"
source_sha256: "1429d76af8cd0fcd88fffd2e160da81aec2fbc21ffb3f2601e6670f667c5d981"
---
...
![PDF binder produced from DOCX, XLSX, and PDF sources - captured from a live run](/net/merger/images/how-to-create-pdf-binder-using-csharp/result.gif)
...
- <a href="https://reference.groupdocs.com/merger/net/" target="_blank" rel="nofollow noopener noreferrer">API Reference</a> - full API surface for GroupDocs.Merger for .NET
- <a href="https://docs.groupdocs.com/merger/net/" target="_blank" rel="nofollow noopener noreferrer">Product documentation</a> - getting started and advanced topics
- <a href="https://github.com/groupdocs-merger/GroupDocs.Merger-for-.NET" target="_blank" rel="nofollow noopener noreferrer">GitHub repository</a> - complete source code and more examples
