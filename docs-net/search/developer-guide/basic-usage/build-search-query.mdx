...
sidebar_label: "Build search query"
sidebar_key: "net-search-build-search-query"
sidebar_position: 2
...
source_path: "net/developer-guide/basic-usage/build-search-query.md"
source_commit: "317e9e9efc13d3cac31121f79ed723a45ab24f80"
source_sha256: "ac2cee12fcebb021d80f6189c138786512ae11e9e820b0897ca6fc6a961ef43f"
---
...
This page contains information about building text search queries of various types. More examples on building search queries are provided on the page [Search operation table](/net/search/developer-guide/advanced-usage/searching/search-operation-table/). A detailed specification of search query language is presented on the page [Query language specification](/net/search/developer-guide/advanced-usage/searching/query-language-specification/).

In addition to text search queries, there is also the ability to create queries in an object form. Search query forms are described on the page [Queries in text and object form](/net/search/developer-guide/advanced-usage/searching/queries-in-text-and-object-form/).

You can also use search options to customize your search queries. Detailed information on search options is provided on the page [Search options](/net/search/developer-guide/advanced-usage/searching/search-options/).
...
A more complex type of query is a wildcard search query. There are 2 types of wildcard characters in a word: a one character wildcard and a character group wildcard. Detailed information about wildcards in a word is provided on the page [Wildcard search](/net/search/developer-guide/advanced-usage/searching/wildcard-search/). The example below demonstrates use of the one character wildcard.
...
The following type of query allows you to specify a range of numbers to search - numeric range search query. Detailed information about numeric range search is presented on the page [Numeric range search](/net/search/developer-guide/advanced-usage/searching/numeric-range-search/). The example below demonstrates how to search for numbers in the range from 2000 to 3000.
...
Search for dates from a particular range is performed using a date range search query. Details on the date range search are presented on the page [Date range search](/net/search/developer-guide/advanced-usage/searching/date-range-search/). The example demonstrates how to search for dates in the format 'MM/dd/yyyy' in the range from 01/01/2000 to 06/15/2001.
...
The next type of query is a regular expression search query. Detailed information about queries of this type is presented on the page [Regular expression search](/net/search/developer-guide/advanced-usage/searching/regular-expression-search/). The following example demonstrates the use of regular expressions to search in an index.
...
Another type of query - a phrase search query - allows you to search entire phrases in documents. Detailed information on the phase search is on the page [Phrase search](/net/search/developer-guide/advanced-usage/searching/phrase-search/). An example of the phrase search is presented below.
