...
source_path: "net/developer-guide/advanced-usage/searching/phrase-search.md"
source_commit: "317e9e9efc13d3cac31121f79ed723a45ab24f80"
source_sha256: "2b54970f04be7bbd8b9791c5b13f3bdad9280736439819146b4707f2b1099b20"
---
...
Phrase search can be combined with other types of searches. The specification of search queries in text form is presented on the [Query language specification](/net/search/developer-guide/advanced-usage/searching/query-language-specification/) page. A table of the possibility of nesting search queries in object form is presented on the [Nesting search queries in object form](/net/search/developer-guide/advanced-usage/searching/nesting-search-queries-in-object-form/) page.
