...
sidebar_label: "Compare Metadata Between Document Versions"
sidebar_key: "net-metadata-compare-metadata-between-document-versions"
sidebar_position: 10
...
source_path: "net/use-cases/compare-metadata-between-document-versions.md"
source_commit: "63b86dac442b8f3b48df2f3a352c0da95426b1cc"
source_sha256: "0f562f4165c4501d7ffb2a7e36f05a12a75a8d64d09a6bd97788a8fbcbfad776"
---
...
<a href="https://github.com/groupdocs-metadata/metadata-diff-between-docs-using-groupdocs-metadata-dotnet" target="_blank" rel="nofollow noopener noreferrer">metadata-diff-between-versions-using-groupdocs-metadata-dotnet</a>
:::
...
As of March 2024, GroupDocs.Metadata supports **over 200 file types** <a href="https://docs.groupdocs.com/metadata/net/" target="_blank" rel="nofollow noopener noreferrer">Docs</a>, eliminating the need for format‑specific parsers and reducing the risk of missed properties.
