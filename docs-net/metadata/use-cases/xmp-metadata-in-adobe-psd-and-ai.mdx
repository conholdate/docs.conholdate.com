...
sidebar_label: "XMP Metadata Operations for PSD and AI Files - Technical Deep Dive"
sidebar_key: "net-metadata-xmp-metadata-in-adobe-psd-and-ai"
sidebar_position: 1
...
source_path: "net/use-cases/xmp-metadata-in-adobe-psd-and-ai.md"
source_commit: "63b86dac442b8f3b48df2f3a352c0da95426b1cc"
source_sha256: "453e708ab8481447ad32e15721b5196e6ade7bc0fdbb3120bb62f258ba324767"
---
...
<a href="https://github.com/groupdocs-metadata/edit-xmp-in-psd-and-ai-files-using-groupdocs-metadata-dotnet" target="_blank" rel="nofollow noopener noreferrer">edit-xmp-in-psd-and-ai-files-using-groupdocs-metadata-dotnet</a>
:::
...
:::warning
**For Production Use:** run the <a href="https://github.com/groupdocs-metadata/edit-xmp-in-psd-and-ai-files-using-groupdocs-metadata-dotnet" target="_blank" rel="nofollow noopener noreferrer">complete implementation</a> against samples from your own asset pipeline before deployment.
:::
...
Licensing follows the usual model: evaluation mode reproduces everything in this guide, and a <a href="https://purchase.groupdocs.com/temp-license/100216" target="_blank" rel="nofollow noopener noreferrer">temporary license</a> lifts evaluation limits for production batches.
...
A: XMP is one of three metadata standards a PSD can carry. The same library reads EXIF and IPTC through their own packages, so a complete asset profile usually combines the XMP snapshot here with those reads. The <a href="https://docs.groupdocs.com/metadata/net/working-with-xmp-metadata/" target="_blank" rel="nofollow noopener noreferrer">Working with XMP metadata</a> page covers the XMP side in reference form.
...
**Next Steps:**
- Run the <a href="https://github.com/groupdocs-metadata/edit-xmp-in-psd-and-ai-files-using-groupdocs-metadata-dotnet" target="_blank" rel="nofollow noopener noreferrer">complete source code</a> against your own PSD and AI samples
- Review the <a href="https://reference.groupdocs.com/metadata/net/" target="_blank" rel="nofollow noopener noreferrer">API Reference</a> for the full XMP surface

## See Also

- <a href="https://blog.groupdocs.com/metadata/xmp-metadata-in-adobe-psd-and-ai-net/" target="_blank" rel="nofollow noopener noreferrer">In-depth blog article about this project</a> - business context and the full pipeline
- <a href="https://docs.groupdocs.com/metadata/net/working-with-xmp-metadata/" target="_blank" rel="nofollow noopener noreferrer">Working with XMP metadata</a> - reference for reading, updating, and adding XMP packages
- <a href="https://docs.groupdocs.com/metadata/net/" target="_blank" rel="nofollow noopener noreferrer">Product documentation</a> - getting started and advanced topics
- <a href="https://reference.groupdocs.com/metadata/net/" target="_blank" rel="nofollow noopener noreferrer">API Reference</a> - full API details for GroupDocs.Metadata for .NET
