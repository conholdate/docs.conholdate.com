...
sidebar_key: "net-markdown-licensing-and-subscription"
sidebar_position: 6
...
If you wish to test GroupDocs.Markdown without the limitations of the trial version, you can also request a 30-day Temporary License. For more details, see the <a href="https://purchase.conholdate.com/temporary-license" target="_blank">"Get a Temporary License"</a> page.

## How to Set a License


:::info
You can find pricing information on the <a href="https://purchase.conholdate.com/pricing/markdown/net" target="_blank">"Pricing Information"</a> page.
:::
