...
1. Instantiate the desired cache object (for example, <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.caching/filecache" target="_blank" rel="nofollow noopener noreferrer">FileCache</a> to store document rendering results at the local drive)
2. Instantiate the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewersettings" target="_blank" rel="nofollow noopener noreferrer">ViewerSettings</a> object. Specify the cache object as a parameter of the constructor.
...
4. Call the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewer/methods/view" target="_blank" rel="nofollow noopener noreferrer">View</a> method of the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewer" target="_blank" rel="nofollow noopener noreferrer">Viewer</a> class.
