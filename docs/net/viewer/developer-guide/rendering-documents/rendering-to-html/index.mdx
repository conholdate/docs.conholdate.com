...
slug: "/net/viewer/developer-guide/rendering-documents/rendering-to-html/"
product: "viewer"
platform: "net"
...
2. Instantiate the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.options/htmlviewoptions" rel="nofollow">HtmlViewOptions</a> object. Specify a path to save the rendered  pages.
3. Call the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewer/methods/view" rel="nofollow">View</a> method of the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewer" rel="nofollow">Viewer</a> object. Specify the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.options/htmlviewoptions" rel="nofollow">HtmlViewOptions</a> object as the parameter.
