...
slug: "/net/viewer/developer-guide/rendering-documents/rendering-to-html/minify-html/"
product: "viewer"
platform: "net"
...
The <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.options/htmlviewoptions" rel="nofollow">HtmlViewOptions</a> class has the <a href="https://reference.groupdocs.com/viewer/net/groupdocs.viewer.options/htmlviewoptions/minify/" rel="nofollow">Minify</a> boolean property that is a flag to minify the output content.
