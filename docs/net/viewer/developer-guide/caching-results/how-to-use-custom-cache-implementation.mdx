...
slug: "/net/viewer/developer-guide/caching-results/how-to-use-custom-cache-implementation/"
product: "viewer"
platform: "net"
...
1. Create the RedisCache class that implements the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.caching/icache" rel="nofollow">ICache</a> interface.
2. Instantiate the RedisCache class.
3. Instantiate the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewersettings" rel="nofollow">ViewerSettings</a> class. Specify the RedisCache object as a parameter of the constructor.
4. Instantiate the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewer" rel="nofollow">Viewer</a> class. Specify the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewersettings" rel="nofollow">ViewerSettings</a> object as a parameter of the constructor.
5. Call the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewer/methods/view" rel="nofollow">View</a> method of the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer/viewer" rel="nofollow">Viewer</a> class.
