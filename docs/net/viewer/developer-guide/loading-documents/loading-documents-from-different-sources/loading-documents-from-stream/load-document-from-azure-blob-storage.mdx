...
slug: "/net/viewer/developer-guide/loading-documents/loading-documents-from-different-sources/loading-documents-from-stream/load-document-from-azure-blob-storage/"
product: "viewer"
platform: "net"
...
:::info
Runnig this code requires installing <a href="https://nuget.org/packages/Azure.Storage.Blobs" rel="nofollow">Azure.Storage.Blobs</a> NuGet package.
:::
