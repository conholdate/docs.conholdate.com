...
slug: "/net/viewer/developer-guide/logging/"
product: "viewer"
platform: "net"
...
To log, use the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.logging/ilogger" rel="nofollow">ILogger</a> interface. It defines the methods required to instantiate and release the output file stream. Also, use the following classes:

* The <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.logging/consolelogger" rel="nofollow">ConsoleLogger</a> class defines the methods required to log to the console.
* The <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.logging/filelogger" rel="nofollow">FileLogger</a> class defines the methods required to log to a file.
...
The following code snippet shows how to log to a file using the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.logging/filelogger" rel="nofollow">FileLogger</a> class:
...
The following code snippet shows how to log to the console using the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.logging/consolelogger" rel="nofollow">ConsoleLogger</a> class:
...
To create a logger, implement the <a href="https://reference.groupdocs.com/net/viewer/groupdocs.viewer.logging/ilogger" rel="nofollow">ILogger</a> interface:
