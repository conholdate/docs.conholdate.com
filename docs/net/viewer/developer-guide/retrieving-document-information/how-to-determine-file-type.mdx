...
slug: "/net/viewer/developer-guide/retrieving-document-information/how-to-determine-file-type/"
product: "viewer"
platform: "net"
...
To determine the file type from the file extension, use the <a href="https://reference.groupdocs.com/viewer/net/groupdocs.viewer/filetype/fromextension/#fromextension" rel="nofollow">FromExtension()</a> method of <a href="https://reference.groupdocs.com/viewer/net/groupdocs.viewer/filetype/" rel="nofollow">FileType</a>.
...
If you receive a file via the Internet, you can check its media type header using the <a href="https://reference.groupdocs.com/viewer/net/groupdocs.viewer/filetype/methods/frommediatype" rel="nofollow">FromMediaType()</a> method of the <a href="https://reference.groupdocs.com/viewer/net/groupdocs.viewer/filetype" rel="nofollow">FileType</a> class.
